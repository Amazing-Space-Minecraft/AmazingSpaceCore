...
abstract class HullFactory: PowerStoringMultiblock(), FurnaceMultiblock {
	...
	val hullBlock = setOf<Material>(STONE_BRICKS, MOSSY_STONE_BRICKS, QUARTZ_BLOCK, SMOOTH_QUARTZ,NETHER_BRICK,RED_NETHER_BRICKS,BLACKSTONE,POLISHED_BLACKSTONE,POLISHED_BLACKSTONE_BRICKS,
